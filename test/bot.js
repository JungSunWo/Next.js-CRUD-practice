...
.slide_btm_sheet { display:block; position:fixed;bottom:0;left:0;z-index:80;width:100%;height: 26.6rem;}
.slide_btm_sheet .btm_wrap { overflow:hidden;position:absolute;bottom:0;z-index:81;padding:0 2rem;width:100%;height:26.6rem;border-radius:2rem 2rem 0 0;background:#fff;transition:all 0.3s ease-out;-webkit-transition:all 0.3s ease-out;box-shadow: 0 -0.6rem 1rem 0 rgba( 33, 37, 41, 0.02), 0 -0.1rem 1.6rem 0 rgba(33, 37,41, 0.04);}
